...
Evaluation of the `deepstream-sop` skill before publication through NVSkills-Eval.
...
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Instructions' (`team-skills/deepstream/deepstream-sop/SKILL.md`)
- MEDIUM SCHEMA/body_recommended_section: Missing recommended section: '## Examples' (`team-skills/deepstream/deepstream-sop/SKILL.md`)
- LOW SCHEMA/unexpected_file: Unexpected 'configs' in skill root (`team-skills/deepstream/deepstream-sop/configs`)
